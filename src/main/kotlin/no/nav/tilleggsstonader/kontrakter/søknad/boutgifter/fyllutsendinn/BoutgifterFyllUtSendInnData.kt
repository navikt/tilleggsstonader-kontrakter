...
data class SkjemaBoutgifter(
    ...
    val harDuNedsattArbeidsevne: String?,
...
data class BoligEllerOvernatting(
    ...
    val samling: Samling?,
    val harDuSaerligStoreUtgifterPaGrunnAvFunksjonsnedsettelse: String,
)
...
data class FasteUtgifter(
    ...
    val harDuLeieinntekterSomDekkerUtgifteneTilBoligenPaHjemstedetDitt: String?,
...
data class Aktiviteter(
    ...
    val hvilkenArbeidsrettetAktivitetHarDu: String?,
)
