...
enum class DokumentBrevkode(
    ...
    REISE_OPPSTART_AVSLUTNING_ELLER_HJEMREISE("NAV 11-12.18"),
    REISE_OPPSTART_AVSLUTNING_ELLER_HJEMREISE_GAMMEL("NAV 11-12.18B"),
    ...
    fun tilSkjematype(): Skjematype? =
        when (this) {
            ...
            REISE_OPPSTART_AVSLUTNING_ELLER_HJEMREISE -> Skjematype.SØKNAD_REISE_OPPSTART_AVSLUTNING_HJEMREISE
