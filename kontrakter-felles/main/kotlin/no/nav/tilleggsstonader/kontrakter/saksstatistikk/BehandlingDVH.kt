...
enum class SakYtelseDvh {
    ...
    TILLEGG_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO,
    TILLEGG_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR,
    ;
    ...
    companion object {
        ...
        fun fraStønadstype(stønadstype: Stønadstype) =
            when (stønadstype) {
                ...
                Stønadstype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO -> TILLEGG_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO
                Stønadstype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR -> TILLEGG_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR
            }
    }
}
