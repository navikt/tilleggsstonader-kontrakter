...
enum class SakYtelseDvh {
    ...
    TILLEGG_STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO,
    TILLEGG_STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR,
    ;
    ...
    companion object {
        ...
        fun fraStønadstype(stønadstype: Stønadstype) =
            when (stønadstype) {
                ...
                Stønadstype.STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO -> TILLEGG_STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO
                Stønadstype.STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR -> TILLEGG_STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR
            }
    }
}
