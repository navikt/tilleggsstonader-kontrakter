...
enum class Dokumenttype {
    ...
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_SØKNAD,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_SØKNAD_VEDLEGG,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_VEDTAKSBREV,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_FRITTSTÅENDE_BREV,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_INTERNT_VEDTAK,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_KLAGE_VEDTAKSBREV,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_KLAGE_INTERNT_VEDTAK,

    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_SØKNAD,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_SØKNAD_VEDLEGG,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_VEDTAKSBREV,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_FRITTSTÅENDE_BREV,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_INTERNT_VEDTAK,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_KLAGE_VEDTAKSBREV,
    REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_KLAGE_INTERNT_VEDTAK,
}
    ...
    get() =
        when (this) {
            ...
            Stønadstype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO ->
                Dokumentyper(
                    søknad = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_SØKNAD,
                    søknadVedlegg = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_SØKNAD_VEDLEGG,
                    vedtaksbrev = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_VEDTAKSBREV,
                    frittståendeBrev = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_FRITTSTÅENDE_BREV,
                    interntVedtak = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_INTERNT_VEDTAK,
                    klageVedtaksbrev = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_KLAGE_VEDTAKSBREV,
                    klageInterntVedtak = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO_KLAGE_INTERNT_VEDTAK,
                    kjøreliste = null,
                    kjørelisteVedlegg = null,
                )
            Stønadstype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR ->
                Dokumentyper(
                    søknad = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_SØKNAD,
                    søknadVedlegg = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_SØKNAD_VEDLEGG,
                    vedtaksbrev = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_VEDTAKSBREV,
                    frittståendeBrev = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_FRITTSTÅENDE_BREV,
                    interntVedtak = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_INTERNT_VEDTAK,
                    klageVedtaksbrev = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_KLAGE_VEDTAKSBREV,
                    klageInterntVedtak = Dokumenttype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR_KLAGE_INTERNT_VEDTAK,
                    kjøreliste = null,
                    kjørelisteVedlegg = null,
                )
        }
