...
class RettighetTest {
    ...
    fun `skal mappe rettighet til stønadstype`() {
        assertThat(Rettighet.PASS_AV_BARN.stønadstype).isEqualTo(Stønadstype.PASS_AV_BARN)
        assertThat(Rettighet.PASS_AV_BARN_ARBEIDSSSØKERE.stønadstype).isEqualTo(Stønadstype.PASS_AV_BARN)
    ...
    fun `skal finne alle rettigheter for gitt stønadstype`() {
        assertThat(Rettighet.fraStønadstype(Stønadstype.PASS_AV_BARN))
